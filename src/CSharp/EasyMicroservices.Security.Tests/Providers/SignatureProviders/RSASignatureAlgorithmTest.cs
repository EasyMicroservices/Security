...
{
    public class RSASignatureAlgorithmTest : BaseSignatureAlgorithmProviderTest
    {
        ...
        public RSASignatureAlgorithmTest() : base(new RSASignatureAlgorithm(publicKey,privateKey))
        {
        }
        [Theory]
